...
CREATE TABLE IF NOT EXISTS Team_Attributes (
    ...
    CONSTRAINT Team_FIFA_API_FK FOREIGN KEY (team_fifa_api_id) REFERENCES Team(team_fifa_api_id),
...
CREATE TABLE IF NOT EXISTS `Match` (
    ...
    away_player_Y10 INT,
    away_player_Y11 INT,
    home_player_1 INT NOT NULL,
    home_player_2 INT NOT NULL,
    home_player_3 INT NOT NULL,
    home_player_4 INT NOT NULL,
    home_player_5 INT NOT NULL,
    home_player_6 INT NOT NULL,
    home_player_7 INT NOT NULL,
    home_player_8 INT NOT NULL,
    home_player_9 INT NOT NULL,
    home_player_10 INT NOT NULL,
    home_player_11 INT NOT NULL,
    away_player_1 INT NOT NULL,
    away_player_2 INT NOT NULL,
    away_player_3 INT NOT NULL,
    away_player_4 INT NOT NULL,
    away_player_5 INT NOT NULL,
    away_player_6 INT NOT NULL,
    away_player_7 INT NOT NULL,
    away_player_8 INT NOT NULL,
    away_player_9 INT NOT NULL,
    away_player_10 INT NOT NULL,
    away_player_11 INT NOT NULL,
    goal LONGTEXT,
    shoton LONGTEXT,
    shotoff LONGTEXT,
    foulcommit LONGTEXT,
